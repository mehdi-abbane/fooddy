...
function autoloader($resource = '')
{
	...
	if ('inc' === $path[0]) {
		...
		$resource_path = sprintf('%s/inc/%s/%s.php', untrailingslashit(FOODDY_DIR_PATH), $directory, $file_name);
	}
...
spl_autoload_register('\FOODDY_THEME\Inc\Helpers\autoloader');
